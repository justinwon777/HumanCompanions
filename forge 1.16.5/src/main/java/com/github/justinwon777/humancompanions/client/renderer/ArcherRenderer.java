...
public class ArcherRenderer extends BipedRenderer<AbstractHumanCompanionEntity, PlayerModel<AbstractHumanCompanionEntity>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(HumanCompanions.MOD_ID, "textures/entities" +
            "/archer.png");

    public ArcherRenderer(EntityRendererManager context) {
