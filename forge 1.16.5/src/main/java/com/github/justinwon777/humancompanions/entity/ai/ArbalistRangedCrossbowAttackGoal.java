...
public class ArbalistRangedCrossbowAttackGoal<T extends AbstractHumanCompanionEntity & IRangedAttackMob & ICrossbowUser> extends Goal {
    ...
    public ArbalistRangedCrossbowAttackGoal(T p_i50322_1_, double p_i50322_2_, float p_i50322_4_) {
