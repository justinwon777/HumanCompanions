...
import com.github.justin.companions.core.ConfiguredStructures;
import com.github.justin.companions.core.EntityInit;
import com.github.justin.companions.core.StructureInit;
    ...
    public void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerLevel serverLevel){
            ...
            try {
                ...
                Companions.LOGGER.error("Was unable to check if " + serverLevel.dimension().location() + " is using " +
