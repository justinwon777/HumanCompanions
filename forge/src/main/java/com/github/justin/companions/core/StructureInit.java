...
import com.github.justin.companions.world.CompanionHouseStructure;
...
public class StructureInit {
    public static final DeferredRegister<StructureFeature<?>> DEFERRED_REGISTRY_STRUCTURE =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, Companions.MOD_ID);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                COMPANION_HOUSE.get(),
                new StructureFeatureConfiguration(17,
                        15,
                        1234567890),
                true);
    }
